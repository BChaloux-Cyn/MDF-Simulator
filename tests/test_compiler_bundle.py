"""
tests/test_compiler_bundle.py — RED stubs for bundle determinism and structure (Plan 04).

These tests are RED until compiler/packager.py is implemented in Plan 04.
The import of `compiler.packager` fails because the module does not exist yet.
...
# ---------------------------------------------------------------------------
# RED sentinel: import fails until Plan 04 creates compiler/packager.py
# ---------------------------------------------------------------------------
pytest.importorskip(
    "compiler.packager",
    reason="compiler.packager not yet implemented (Plan 04)",
)
